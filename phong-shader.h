...
static const GLchar *glslPhongVert =
"#define MAX_LIGHTS 4																																			\n"
...
static const GLchar *glslPhongFrag =
...
static const GLchar* glslPhongVertTexture =
"#define MAX_LIGHTS 4																																		\n"
"attribute vec3 a_position;																																	\n"
...
static const GLchar* glslPhongFragTexture =
"precision mediump float;														\n"
"varying vec4 v_color;															\n"
"																				\n"
...
static const GLchar* glslPhongFragTextureToAlpha =
"precision mediump float;														\n"
"varying vec4 v_color;															\n"
"																				\n"
"uniform sampler2D uTexture;													\n"
...
"		discard;                                                                \n"
#else
"	if (v_texCoord.y >= sin(uAccTime)*sin(uAccTime))							\n"
"		color = vec4(0.0);														\n"
#endif
"																				\n"
"	gl_FragColor = color;														\n"
...
static const GLchar* glslPhongVertAnimated =
"#define MAX_LIGHTS 4																																\n"
"attribute vec3 a_position;																															\n"
"attribute vec3 a_normal;																															\n"
...
static const GLchar* glslPhongFragAnimated = glslPhongFrag;

static const GLchar* glslPhongVertTextureAnimated =
"#define MAX_LIGHTS 4																																\n"
"attribute vec3 a_position;																															\n"
"attribute vec2 a_texCoord;																															\n"
"attribute vec3 a_normal;																															\n"
...
static const GLchar* glslPhongFragTextureAnimated = glslPhongFragTexture;